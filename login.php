...
if ($action=="login")
{
	...
	if ($user=="" || $pass=="")
	{
		if ($user=="")
		{
			$cErr->Error("Si us plau, introdueix un nom d'usuari per Entrar.");
		} else {
			$cErr->Error("Si us plau! introdueix una contrasenya vàlida per a aquest compte. Si no recordes la contrasenya, pots demanar una nova.");
		}
