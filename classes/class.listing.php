...
class cListing
{
	...
	function DisplayListing()
	{
		...
		if($this->rate != "")
			$output .= "<STRONG>Valoración:</STRONG> ". $this->rate ."<BR>";		
		...
		if(isset($this->listing)) {
			foreach($this->listing as $listing) {
                ...
                {   $details .= " (". $listing->member_id; 
					...
					$details .= ': <font color="red">Su saldo es inferior a 1 Hora</font>';  
                    $details .= ")";                   
				}
