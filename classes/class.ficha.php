...
class cFicha {
    ...
    $this->pdf->Line(13.2,84.3,128.2,84.3);  
     ...
     function ImagenTop () {
     $this->pdf->image('images/top.jpg', 23.6, 38.0, 0, 0); 
    }   
   ...
   */  
     ...
     // $socio=iconv('utf-8', 'windows-1252', $socio);
     $socio=utf8_decode( $socio);
     $this->pdf->Cell( 29.6,"", $socio,"","", $align = 'L');  
       //comentamos los bloque que muestran los datos por telefonos.
