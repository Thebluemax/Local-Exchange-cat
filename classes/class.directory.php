...
class cDirectory {
    ...
    function DownloadDirectory () {    
        ...
        $this->PrintSectionHeader("INFORMACIÓN DE LOS MIEMBROS",FIRST);
        $this->PrintMembers();
    
        $this->PrintSectionHeader("OFERTAS");
        $this->PrintListings(OFFER_LISTING);
        
        $this->PrintSectionHeader("DEMANDAS");
        $this->PrintListings(WANT_LISTING);
        
        $this->pdf->Output("bancodetiempo.pdf",false);
    }
