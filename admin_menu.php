...
$list .= "<A HREF=listing_create.php?type=Offer&mode=admin><FONT SIZE=3>Crear una nueva oferta</FONT></A><BR>";
...
$list .= "<A HREF=listing_create.php?type=Want&mode=admin><FONT SIZE=3>Crear una nueva demanda</FONT></A><BR>";
