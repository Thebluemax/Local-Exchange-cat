...
define ("SERVER_DOMAIN","www.tubanco.org");    // no http://
...
//Importante dejar ya que debemos usar esta libreria.
...
define ("DATABASE_USERNAME","tu_db_user");
define ("DATABASE_PASSWORD","*****");
define ("DATABASE_NAME","bdt_db");
...
define ("SITE_LONG_TITLE", "Banc del Temps ");

// What is the short, friendly, name of the site?
define ("SITE_SHORT_TITLE", "BdT ");
...
define ("EMAIL_FEATURE_REQUEST","Banc del Temps de SALT". "<bancdeltempsdesalt@gmail.com>");
define ("EMAIL_ADMIN","Banc del Temps de Salt". "<bancdeltempsdesalt@gmail.com");
define ("PHONE_ADMIN","Banc del Temps de Salt". "<bancdeltempsdesalt@gmail.com"); // an email address may be substituted...
define ("EMAIL_FROM","Banc del Temps de Salt". "<bancdeltempsdesalt@gmail.com"); // to override EMAIL_ADMIN 
                                                                                // for replies
...
define ("PAGE_FOOTER_CONTENT", "<tr><td id=\"footer\" colspan=2><p align=center><a href=''><strong>". SITE_LONG_TITLE ." </a>--<a href='mailto:bancdeltempsdesalt@gmail.com'>bancdeltempsdesalt@gmail.com</a></strong><br>
...
address (info@bancdeltempsdesalt.org) and then delete it immediately. We also inform you
