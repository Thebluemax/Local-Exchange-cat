...
$p->page_title = "Escoge la noticia a editar";
...
if($news_array = $news->MakeNewsArray()) {
    $form->addElement("select", "news_id", "¿Qué noticia?", $news_array);
    $form->addElement("static", null, null, null);
    $form->addElement('submit', 'btnSubmit', 'Editar');
} else {
    $form->addElement("static", null, "No hay ninguna noticia publicada.", null);
}
