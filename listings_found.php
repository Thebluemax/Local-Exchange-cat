...
if ($_REQUEST["type"] == "Offer") $p->page_title = "Ofertes";
if ($_REQUEST["type"] == "Want") $p->page_title = "Demandes";
...
// ***** fecha 21 de abril 2012 lo quito para que se vean todas las ofertas
