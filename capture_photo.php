...
$p->page_title = "Capturar foto";

$list='<div id="captura"></div>'; 
$list.='<br/><form><input type=hidden name="member_id" value="'.$_REQUEST["member_id"].'"><input type=button value="Configurar..." onClick="webcam.configure()">&nbsp;&nbsp;&nbsp;<input type=button value="Sacar foto" onClick="webcam.snap()"></form>'; 
...
{ 
 ...
 if(!$update)
            $cErr->Error("No se ha podido actualizar la imagen");         
