...
if ($_REQUEST["type"] == "Offer") $p->page_title = "Tria l'oferta a editar";
if ($_REQUEST["type"] == "Want") $p->page_title = "Tria la Demanda a editar";
...
if($list == "")
	$list = "No hi ha cap element a editar.";
