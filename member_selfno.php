...
$parrafada .="D'acord amb la normativa de protecció de dades de caràcter personal, t'informem que les teves dades personals han estat incorporades a sengles fitxers de Persones participants en el Banc del Temps del Pont del Dimoni, mantinguts sota la responsabilitat de la AAVV Santa Eugenía i Sant Narcis. Únicament s'utilitzaran amb la finalitat de participar en el Banc del Temps del Pont del Dimoni i donar-los a conèixer pel que fa al Banc, i exclusivament es cediran als usuaris del Banc amb la mateixa finalitat, segons estableix la normativa vigent. Així mateix t'informem que pots exercir els drets d'accés, rectificació, cancel.lació i oposició davant el responsable del fitxer al carrer Santa Eugenia 146, 17006 - Girona o en bancdeltemps@eldimoni.com"."\n\n\n";
$parrafada .="Responsabilitat:"."\n\n"; 
$parrafada .="El Banc del Temps del Pont del Dimoni només contacta els usuaris que diuen poder oferir un servei. El Banc del Temps no pot assegurar el rendiment de cap dels usuaris del Banc del Temps, de manera que mai serà el Banc del Temps del Pont del Dimoni responsable per cap lesió o dany a la propietat experimentats durant les transaccions."."\n";
$parrafada .="El Banc del Temps del Pont del Dimoni ofereix en la seva eina informàtica formes de conèixer les experiències que tots els usuaris han tingut mentre oferien serveis a altres usuaris del banc del temps."."\n\n\n";  
...
$parrafada .="Si hi hagués un problema real amb el servei rebut, Banc del Temps del Pont del Dimoni, ofereix en la seva eina informàtica formes de conèixer les experiències que tots els usuaris han tingut mentre oferien serveis a altres usuaris del banc del temps. El Banc de Temps intervindrà dins de les seves capacitats en els conflictes entre usuaris que no s'hagin pogut arreglar i les seves decisions sempre seran finals i sense possibilitat d'apel.lació. Si hagués accions irregulars el Banc del Temps del Pont del Dimoni podrà sancionar els usuaris, des obligar-los a retornar el crèdit obtingut fins a l'expulsió del sistema."."\n\n\n"; 
...
//	$values['fax_ext'] = $phone->ext;	
	...
	if($created = $new_person->SaveNewPerson()) 
	  ...
	  if($created) {
        $list .= "Ja has estat creat, ara hauràs d'esperar una mica a que et responguem.<br>\nRecorda que el teu nom d'associat es <strong>". $values["member_id"]. "</strong> i la teva contrasenya <strong>". $values["password"] . "</strong><br><br>Prem <A HREF=member_create.php>aquí</A> si vols crear un altre compte.";
        if($values['email'] == "") {
        $list .= "<br>Normalment avisem per email, però no has donat cap. Espera uns pocs dies i fes la prova per veure si et pots donar d'alta. Si tens pressa, posa't en contacte amb el Banc del Temps per telèfon. ";                                                                                                                                                                                                     
        } else {
            //$text = NEW_MEMBER_PENDING . "\n\nID Membre: ". $values['member_id'] ."\n". "Contrasenya: xxxxx ";
			//  lo quito en junio 2011 (pablo) para que no se vea la password:
...
// mail($to, $subject, $message, $headers);// 
            ...
            if (PEAR::isError($mailed)) {
               ...
               $list .= "<br>Hem enviat un email a la teva adreça '". $values["email"] ."'. En uns pocs dies et donarem d'alta. Si tens pressa, posa't en contacte amb nosaltres per telèfon."; $to .= 'bancdeltemps@eldimoni.com';			

//nuevo-----------------------------------------------------------------------------------
$to  = $values['bancdeltemps@eldimoni.com'] . ', '; // ojo con la comma *********
//$to = 'bancdeltemps@eldimoni.com';			
            $crlf = "\n";
            $headers = array ('From' => EMAIL_FROM,
            'To' => $to,
